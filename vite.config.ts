...
export default defineConfig(({ mode }) => {
  ...
  const supabaseRedirectUrl = env.VITE_PUBLIC_SUPABASE_REDIRECT_URL || env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || '';
  ...
  define: {
    ...
    'import.meta.env.VITE_PUBLIC_SUPABASE_REDIRECT_URL': JSON.stringify(supabaseRedirectUrl),
  },
  optimizeDeps: {
